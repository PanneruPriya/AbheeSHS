...
public class ChangePassword extends Fragment {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(newp.getText().toString().equals(confirmp.getText().toString())) {
                    ...
                    Toast.makeText(getActivity(),"new password and Confirm password not Matahed",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void sendDetailstoServer() {
        try {
            ...
            JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.POST,
                    Constants.URL+"adminChangePassword", new JSONObject(mRequestBody),
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (obj.getString("password").contains("Not Updated")) {
                            ...
                            Intent i=new Intent(getContext(),LoginPageActivity.class);
                            startActivity(i);
                         }
                        else {
