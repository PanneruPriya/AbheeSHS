package com.abhee.abheetechnician2.service;
...
import com.abhee.abheetechnician2.Constants;
import com.abhee.abheetechnician2.R;
...
public class NotificationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        custid= sharedPreferences.getString("user_id", "");
        // Let it continue running until it is stopped.
        //Toast.makeText(this, "Service Started", Toast.LENGTH_LONG).show();
        Map<String,String> params = new HashMap<>();
        params.put("assignto",custid);
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Constants.URL+"getNotificationByTechnicianId", new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONArray jsonArray = jsonObject.getJSONArray("History1");
